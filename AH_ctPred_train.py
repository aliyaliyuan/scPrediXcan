...
gen_data_p = '/home/aliya/Liver/batch1/FIXED_HG00096_training_input.csv'
gen_data = pd.read_csv(gen_data_p, dtype=str)
gen_data.iloc[:, 2:] = gen_data.iloc[:, 2:].astype(float)
...
saved_path = '/home/aliya/Liver/1111/scPred_test.pt'
